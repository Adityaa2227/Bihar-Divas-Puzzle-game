...
export default function App() {
  ...
  return (
    <div className="h-screen w-screen bg-transparent flex justify-center items-center p-0 relative z-[1] overflow-hidden select-none">
      ...
      <div className="w-full max-w-[480px] md:max-w-[1800px] lg:px-6 h-screen max-h-screen flex flex-col p-0 md:p-1 lg:p-2 relative z-[1] overflow-hidden">
        <Header 
          moves={moves} 
          time={time} 
          bestScore={bestScore}
        ...
        <div className="flex-1 flex flex-col justify-center w-full overflow-hidden min-h-0">
          {view === 'categories' ? (
            ...
            <div className="flex flex-col md:flex-row flex-1 items-center justify-center gap-2 md:gap-4 lg:gap-8 w-full h-full pb-1 max-w-[1600px] mx-auto px-0 md:px-1">
              ...
              {gameMode === GAME_MODES.JIGSAW ? (
                <div className="relative rounded-2xl overflow-hidden shadow-[0_15px_50px_rgba(0,0,0,0.15)] border-[3px] border-[var(--border)] bg-[var(--bg-secondary)] w-[min(90vw,55vh)] h-[min(90vw,55vh)] md:h-[clamp(350px,50vh,600px)] md:w-[clamp(350px,50vh,600px)] xl:h-[clamp(450px,55vh,650px)] xl:w-[clamp(450px,55vh,650px)] aspect-square shrink-0">
                ...
                <div className={`relative aspect-square shrink-0 rounded-2xl overflow-hidden shadow-[0_15px_50px_rgba(0,0,0,0.15)] border-[3px] bg-[var(--bg-secondary)] w-[min(90vw,55vh)] h-[min(90vw,55vh)] md:h-[clamp(350px,50vh,600px)] md:w-[clamp(350px,50vh,600px)] xl:h-[clamp(450px,55vh,650px)] xl:w-[clamp(450px,55vh,650px)] ${gameMode === GAME_MODES.DRAG_DROP ? 'border-dashed border-orange-500' : 'border-[var(--border)]'}`}>
                  {(isPreviewing || showHint) && (
                    <div className={isPreviewing ? "absolute inset-0 z-20 flex items-center justify-center rounded-2xl pointer-events-none" : "absolute inset-0 z-10 flex items-center justify-center bg-black/30 animate-[fadeIn_0.2s_ease] rounded-2xl"}>
                      {showHint && !isPreviewing && (
                        <div className="absolute top-5 right-5 bg-orange-600 text-white py-2 px-4 rounded-full font-extrabold text-xl shadow-[0_4px_15px_rgba(234,88,12,0.4)] z-30 animate-[pulse_1s_infinite_alternate] pointer-events-none">
              ...
              <div className="w-full flex-1 md:flex-none md:w-[380px] lg:w-[460px] max-w-[500px] flex flex-col gap-2 justify-center order-2 md:order-1">
