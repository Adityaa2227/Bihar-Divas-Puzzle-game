...
export const IMAGES = [
  ...
  // --- 55+ YEARS ---
  { id: 'lauria', categoryId: 'heritage', name: 'Lauria Nandangarh', src: '/assets/55+/Lauriya-Nandangarh.webp', fact: 'Maurya Ashokan pillar site.' },
  { id: 'mundeshwari', categoryId: 'heritage', name: 'Mundeshwari Temple', src: '/assets/55+/Mundeshwari-Temple.webp', fact: 'Oldest functional Hindu temple.' },
  { id: 'v-ruins', categoryId: 'heritage', name: 'Vikramshila Ruins', src: '/assets/55+/ruins-of-vikramshila.webp', fact: 'Deep monastic university remains.' },
  { id: 'layout', categoryId: 'heritage', name: 'Old Nalanda Layout', src: '/assets/55+/old nalanda.webp', fact: 'Ancient archaeological grid.' },
  { id: 'telhara', categoryId: 'heritage', name: 'Telhara University', src: '/assets/55+/Telhara-University.webp', fact: 'Excavated ancient education site.' },
  { id: 'old-patna', categoryId: 'modern', name: 'Old Patna City', src: '/assets/55+/old patna city.webp', fact: 'Heritage architecture of old town.' },
  { id: 'sonpur-jnc', categoryId: 'modern', name: 'Sonpur Junction', src: '/assets/55+/sonepur jn.webp', fact: 'Historic railway hub.' },
  { id: 'barauni', categoryId: 'modern', name: 'Barauni Refinery', src: '/assets/55+/barauni refinery.webp', fact: 'Pillar of Bihar industry.' },
  { id: 'haats', categoryId: 'modern', name: 'Traditional Haats', src: '/assets/55+/haats.webp', fact: 'Classic village marketplaces.' },
  { id: 'malpua', categoryId: 'food', name: 'Malpua', src: '/assets/55+/malpua.webp', fact: 'Bihar\'s own sweet pancakes.' },
  { id: 'gur-sweets', categoryId: 'food', name: 'Gur Sweets', src: '/assets/55+/gud sweets.webp', fact: 'Jaggery-based healthy desserts.' },
  { id: 'khichdi', categoryId: 'food', name: 'Traditional Khichdi', src: '/assets/55+/khichdi.webp', fact: 'Bihar Saturday special meal.' },
  { id: 'saag-bhaat', categoryId: 'food', name: 'Saag Bhaat', src: '/assets/55+/saag bhaat.webp', fact: 'Classic rural nutritional meal.' },
  { id: 'handia', categoryId: 'food', name: 'Local Drinks', src: '/assets/55+/local drink.webp', fact: 'Traditional fermented beverages.' },
  { id: 'mauryan-e', categoryId: 'culture', name: 'Mauryan Empire', src: '/assets/55+/mauryan empire.webp', fact: 'Golden era of Bihar\'s past.' },
  { id: 'gupta-e', categoryId: 'culture', name: 'Gupta Empire', src: '/assets/55+/gupta-empire-map.webp', fact: 'Era of science and mathematics.' },
  { id: 'buddhist-c', categoryId: 'culture', name: 'Buddhist Circuits', src: '/assets/55+/buddhist circuit.webp', fact: 'Deep holy exploration routes.' },
];
