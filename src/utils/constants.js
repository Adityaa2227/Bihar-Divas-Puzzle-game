...
export const IMAGES = [
  ...
  // --- 30-55 YEARS ---
  { id: 'vikramshila-u', categoryId: 'heritage', name: 'Vikramshila University', src: 'src/assets/30-55/vikramshila.webp', fact: 'Ancient Buddhist university ruins.' },
  { id: 'rohtasgarh', categoryId: 'heritage', name: 'Rohtasgarh Fort', src: 'src/assets/30-55/Rohtasgarh-Fort.webp', fact: 'Ancient and powerful hill fort.' },
  { id: 'agam-kuan', categoryId: 'heritage', name: 'Agam Kuan', src: 'src/assets/30-55/agam kuan.webp', fact: 'Maurya-era mysterious well.' },
  { id: 'pawapuri', categoryId: 'heritage', name: 'Pawapuri Temple', src: 'src/assets/30-55/pawapuri.webp', fact: 'Place of Mahavira\'s Nirvana.' },
  { id: 'ajatshatru', categoryId: 'heritage', name: 'Ajatshatru Fort', src: 'src/assets/30-55/ajatshatru fort.webp', fact: 'Ancient fortification area.' },
  { id: 'vidhan-sabha', categoryId: 'modern', name: 'Vidhan Sabha', src: 'src/assets/30-55/vidhan sabha.webp', fact: 'Democracy focal point.' },
  { id: 'high-court', categoryId: 'modern', name: 'Patna High Court', src: 'src/assets/30-55/patna high court.webp', fact: 'Seat of judgment in Bihar.' },
  { id: 'nalanda-new', categoryId: 'modern', name: 'Nalanda New Campus', src: 'src/assets/30-55/nalanda new campus.webp', fact: 'Modern rebirth of Nalanda.' },
  { id: 'rajendra-setu', categoryId: 'modern', name: 'Rajendra Setu', src: 'src/assets/30-55/rajendra-setu.webp', fact: 'First Ganges bridge.' },
  { id: 'gaya-airport', categoryId: 'modern', name: 'Gaya Airport', src: 'src/assets/30-55/gaya-airport.webp', fact: 'International gateway for pilgrims.' },
  { id: 'makhana-kheer', categoryId: 'food', name: 'Makhana Kheer', src: 'src/assets/30-55/makhana kheer.webp', fact: 'Sweet dish made of fox nuts.' },
  { id: 'bihari-kebab', categoryId: 'food', name: 'Bihari Kebab', src: 'src/assets/30-55/bihari kebab.webp', fact: 'Soft-marinated spicy skewers.' },
  { id: 'fish-curry', categoryId: 'food', name: 'Bihari Fish Curry', src: 'src/assets/30-55/Bihari-Style-Fish-Curry.webp', fact: 'Mustard-based traditional preparation.' },
  { id: 'aloo-chana', categoryId: 'food', name: 'Aloo Chana Curry', src: 'src/assets/30-55/aloo chana curry.webp', fact: 'Staple flavorful veggie curry.' },
  { id: 'chura-dahi', categoryId: 'food', name: 'Chura Dahi', src: 'src/assets/30-55/dahi-chura.webp', fact: 'Traditional breakfast pair.' },
  { id: 'chanakya', categoryId: 'culture', name: 'Chanakya', src: 'src/assets/30-55/chanakya.webp', fact: 'The great Mauryan strategist.' },
  { id: 'aryabhatta', categoryId: 'culture', name: 'Aryabhatta', src: 'src/assets/30-55/aryabhatta.webp', fact: 'Inventor of Zero from Bihar.' },
  { id: 'dashrath', categoryId: 'culture', name: 'Dashrath Manjhi', src: 'src/assets/30-55/dashrath_manjhi.webp', fact: 'Famous mountain carver.' },
  { id: 'jain-buddha', categoryId: 'culture', name: 'Buddhism Traditions', src: 'src/assets/30-55/buddhism tradition.webp', fact: 'Roots of world religions in Bihar.' },

  // --- 55+ YEARS ---
  { id: 'lauria', categoryId: 'heritage', name: 'Lauria Nandangarh', src: 'src/assets/55+/Lauriya-Nandangarh.webp', fact: 'Maurya Ashokan pillar site.' },
  { id: 'mundeshwari', categoryId: 'heritage', name: 'Mundeshwari Temple', src: 'src/assets/55+/Mundeshwari-Temple.webp', fact: 'Oldest functional Hindu temple.' },
  { id: 'v-ruins', categoryId: 'heritage', name: 'Vikramshila Ruins', src: 'src/assets/55+/ruins-of-vikramshila.webp', fact: 'Deep monastic university remains.' },
  { id: 'layout', categoryId: 'heritage', name: 'Old Nalanda Layout', src: 'src/assets/55+/old nalanda.webp', fact: 'Ancient archaeological grid.' },
  { id: 'telhara', categoryId: 'heritage', name: 'Telhara University', src: 'src/assets/55+/Telhara-University.webp', fact: 'Excavated ancient education site.' },
  { id: 'old-patna', categoryId: 'modern', name: 'Old Patna City', src: 'src/assets/55+/old patna city.webp', fact: 'Heritage architecture of old town.' },
  { id: 'sonpur-jnc', categoryId: 'modern', name: 'Sonpur Junction', src: 'src/assets/55+/sonepur jn.webp', fact: 'Historic railway hub.' },
  { id: 'barauni', categoryId: 'modern', name: 'Barauni Refinery', src: 'src/assets/55+/barauni refinery.webp', fact: 'Pillar of Bihar industry.' },
  { id: 'haats', categoryId: 'modern', name: 'Traditional Haats', src: 'src/assets/55+/haats.webp', fact: 'Classic village marketplaces.' },
  { id: 'malpua', categoryId: 'food', name: 'Malpua', src: 'src/assets/55+/malpua.webp', fact: 'Bihar\'s own sweet pancakes.' },
  { id: 'gur-sweets', categoryId: 'food', name: 'Gur Sweets', src: 'src/assets/55+/gud sweets.webp', fact: 'Jaggery-based healthy desserts.' },
  { id: 'khichdi', categoryId: 'food', name: 'Traditional Khichdi', src: 'src/assets/55+/khichdi.webp', fact: 'Bihar Saturday special meal.' },
  { id: 'saag-bhaat', categoryId: 'food', name: 'Saag Bhaat', src: 'src/assets/55+/saag bhaat.webp', fact: 'Classic rural nutritional meal.' },
  { id: 'handia', categoryId: 'food', name: 'Local Drinks', src: 'src/assets/55+/local drink.webp', fact: 'Traditional fermented beverages.' },
  { id: 'mauryan-e', categoryId: 'culture', name: 'Mauryan Empire', src: 'src/assets/55+/mauryan empire.webp', fact: 'Golden era of Bihar\'s past.' },
  { id: 'gupta-e', categoryId: 'culture', name: 'Gupta Empire', src: 'src/assets/55+/gupta-empire-map.webp', fact: 'Era of science and mathematics.' },
  { id: 'buddhist-c', categoryId: 'culture', name: 'Buddhist Circuits', src: 'src/assets/55+/buddhist circuit.webp', fact: 'Deep holy exploration routes.' },
];
